...
// Data holder class (lebih aman dari Object[])
class Customer {
    String nama;
    int umur;
    double gaji;

    public Customer(String nama, int umur, double gaji) {
        this.nama = nama;
        this.umur = umur;
        this.gaji = gaji;
    }
...
public class Day2_4verClean2 {
    ...
    public static Customer inputCustomer(Scanner scan) {
        ...
        return new Customer(nama, umur, gaji);
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                Customer cust = inputCustomer(scan);

                String decision = cekCustomer(cust.umur, cust.gaji);
                displayResult(cust.nama, decision);
